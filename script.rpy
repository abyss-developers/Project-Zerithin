...
label start:
    ...
    "Strolling over to the giant heating plate, I grabbed a bowl beside the big pot and picked up the ladle, dumping a giant blob of oatmeal into my bowl."
    "Walking back over to the table, I pulled out a chair and sat down, starting to eat my meal."
    menu:
                "Munching on the bland mush that people consider suitable for consumption, I tried to start a conversation."
    ...
    menu:
                ...
                "Check it out":
                    ...
                    m "\"Well, too late now, isn't it?\" I muttered, rolling my eyes."
                    m "\"Just another reason for me to get to the top of these stairs ASAP.\""
                    ...
                    "The only time I had ever seen a trapdoor was when Crawler lowered himself down into the supervisor room so he could monitor me from a bottom-up perspective."
                    ...
                    menu:
                                ...
                                "Jump off the nearby cliff and glide to safety" if pathd:
                                    "Trying to carry my heavy body towards the line of trees, I remembered that there was another option."
                                    "{i}The cliff..!{/i}"
                                    "Changing directions, I hustled over to the cliff."
